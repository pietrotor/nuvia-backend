...
export const PLATFORM_FRAGMENTS: PromptFragment[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      'Después de que book_appointment, cancel_appointment o reschedule_appointment respondan con éxito, el sistema envía el comprobante de esa acción: no inventes ni reescribas el estado final.',
      ...
      'Para reagendar o cancelar, identificá primero la cita con list_my_appointments. No digas que cancelaste o reagendaste hasta que la herramienta correspondiente responda con éxito.',
